h4. Recommended reading on the OR topics

This directory contains the PDF files for focused on various OR (Operations Research) topics relevant for members of _Energy Efficiency in Sustainable Mining Industry_ project of the SAYSSP.

All PDFs listed below are zipped into mca_all.zip.

h5. Basic reading on mathematical modeling and integrated model analysis
* dss_yssp.pdf: Model-based decision support methodology with environmental applications (Wierzbicki, Makowski, Wessels, 2000)
* mm_jcp09.pdf: Management of attainable tradeoffs between conflicting goals (Makowski, 2009)
